        ...
        <div class='row'>
            <div class='col-lg-4 col-md-4 col-sm-12'>
                <div class="form-group" >        
                    <div class="input-group">
                        ...
                        <input type="text" list="contactos-lista" class="form-control" id="contacto-name"  name='nombre_b' placeholder="Nombre del contacto">                      
                        <?=$list_contactos_name;?>
                    </div>
                </div>
            </div>
            <div class='col-lg-4 col-md-4 col-sm-12'>
                <div class="form-group" >
                    <div class="input-group">
                        ...
                        <input type="tel" class="form-control input_tel_contacto" id="contacto-tel-filtro" name='telefono_b' placeholder="51153433..">                      
                    </div>
                </div>             
            </div>
            <div class='col-lg-3 col-md-3 col-sm-12'>
                <div class="form-group" >
                    <div class="input-group">
                        <div class="input-group">
                            <select class="form-control input-sm" name="tipo_b">            
