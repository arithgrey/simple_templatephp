            ...
            <form class='form-filtro' id="form-filtro">    
                <div class='col-lg-4 col-md-3 col-sm-12' title='Filtro criterio'>                    
                    <div class="input-group">
                        ...
                        <input list='razon_social' name='puntos_venta_b' id='puntos-venta-filtro' class='puntos-venta-filtro  input-sm form-control' >
                ...
                <div class='col-lg-3 col-md-3 col-sm-12' title='Filtro criterio'>            
                    <div class="input-group">
                        ...
                        <select name='estado_punto_venta_b' id='estado_punto_venta' class='estado_punto_venta form-control input-sm'>
