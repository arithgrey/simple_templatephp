...
CREATE TABLE IF NOT EXISTS `enidserv_eniddbbbb3`.`imagen` (
  ...
  `base_path` TEXT NULL,
  `fecha_registro` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `status` VARCHAR(200) NOT NULL DEFAULT 'Disponible',
  `base_path_img` VARCHAR(45) NOT NULL,
  `id_usuario` INT NULL,
  `id_empresa` INT NULL,
...
CREATE TABLE IF NOT EXISTS `enidserv_eniddbbbb3`.`empresa_experiencia` (
  ...
  `tel` BIGINT(8) NULL,
  INDEX `fk_empresa_has_contenido_contenido1_idx` (`idcontenido` ASC),
  ...
  CONSTRAINT `fk_empresa_has_contenido_empresa1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_empresa_has_contenido_contenido1`
    FOREIGN KEY (`idcontenido`)
    REFERENCES `enidserv_eniddbbbb3`.`contenido` (`idcontenido`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
CREATE TABLE v_event_serv AS select es.idevento, es.idservicio, es.nota, count(*) servicios from
    evento_servicio es
where
    idevento = id_event
group by idevento;
...
INSERT INTO evento_palabra_clave 
    SELECT  idevento ,  nombre_evento , 1   FROM evento WHERE fecha_inicio = CURRENT_DATE() + dias;
...
SELECT e.idevento , eg.genero  , 2  FROM  evento e 
INNER JOIN evento_genero eg 
ON
e.idevento = eg.id_evento 
WHERE
    fecha_inicio = CURRENT_DATE() + dias;
...
WHEN 2 THEN     
 ...
 /*para cuando indica los evento del proximo mes */

/*Cuando no se indicó fecha*/
/*insertamos palabras claves para evento por nombre**/
INSERT INTO evento_palabra_clave 
    SELECT  idevento ,  nombre_evento , 1  FROM evento 
    WHERE MONTH(fecha_inicio) = MONTH(CURRENT_DATE()) + 1;
...
INSERT INTO evento_palabra_clave 
    SELECT  idevento ,  nombre_evento  , 1  FROM evento 
    WHERE MONTH(fecha_inicio) = MONTH(CURRENT_DATE()) + 2;
...
DELIMITER $$
USE `enidserv_eniddbbbb3`$$
CREATE PROCEDURE enidserv_eniddbbbb3.repo_eventos_admin(emp int) 
BEGIN 
...
SET @d =  CONCAT('CREATE TABLE repo_eventos_escenarios_' , @num , ' AS ' , 'select e.idevento,
    ...
    escenario es ON e.idevento = es.idevento
where
    e.idempresa =' , @num , ' group by e.idevento');
PREPARE stmtd from @d; 
EXECUTE stmtd;
...
START TRANSACTION;
USE `enidserv_eniddbbbb3`;
INSERT INTO `enidserv_eniddbbbb3`.`usuario` (`idusuario`, `nombre`, `email`, `password`, `fecha_registro`, `idempresa`, `descripcion`, `puesto`, `status`, `apellido_paterno`, `apellido_materno`, `email_alterno`, `tel_contacto`, `tel_contacto_alterno`, `edad`, `numero_empleado`, `inicio_labor`, `fin_labor`, `grupo`, `cargo`, `rfc`, `turno`, `ultima_modificacion`, `descripcion_usuario`) VALUES (1, 'arithgrey', 'arithgrey@gmail.com', '870058cbcebe244bce513be539acd6905bca8d99', NULL, 1, NULL, 'Presidente ejecutivo', 'Usuario Activo', 'Medrano', 'Salazar', 'enidservice@gmail.com', 5573355891, 5545444823, 25, NULL, '09:00 AM', '18:00 PM', 'Desarrollo', 'Presidente Ejecutivo', NULL, 'Matutino', NULL, NULL);
INSERT INTO `enidserv_eniddbbbb3`.`usuario` (`idusuario`, `nombre`, `email`, `password`, `fecha_registro`, `idempresa`, `descripcion`, `puesto`, `status`, `apellido_paterno`, `apellido_materno`, `email_alterno`, `tel_contacto`, `tel_contacto_alterno`, `edad`, `numero_empleado`, `inicio_labor`, `fin_labor`, `grupo`, `cargo`, `rfc`, `turno`, `ultima_modificacion`, `descripcion_usuario`) VALUES (2, 'estratega test', 'estrategatest@gmail.com', '870058cbcebe244bce513be539acd6905bca8d99', NULL, 1, NULL, 'Presidente ejecutivo', 'Usuario Activo', NULL, NULL, NULL, NULL, NULL, 25, NULL, '09:00 AM', '18:00 PM', 'Desarrollo', 'Presidente Ejecutivo', NULL, 'Matutino', NULL, NULL);
INSERT INTO `enidserv_eniddbbbb3`.`usuario` (`idusuario`, `nombre`, `email`, `password`, `fecha_registro`, `idempresa`, `descripcion`, `puesto`, `status`, `apellido_paterno`, `apellido_materno`, `email_alterno`, `tel_contacto`, `tel_contacto_alterno`, `edad`, `numero_empleado`, `inicio_labor`, `fin_labor`, `grupo`, `cargo`, `rfc`, `turno`, `ultima_modificacion`, `descripcion_usuario`) VALUES (3, 'administradortest', 'administradortest@gmail.com', '870058cbcebe244bce513be539acd6905bca8d99', NULL, 1, NULL, 'Administrador', 'Usuario Activo', NULL, NULL, NULL, NULL, NULL, 18, NULL, '09:00 AM', '18:00 PM', NULL, NULL, NULL, 'Matutino', NULL, NULL);
...
INSERT INTO `enidserv_eniddbbbb3`.`perfil_recurso` (`idperfil`, `idrecurso`) VALUES (4, 7);
...
INSERT INTO `enidserv_eniddbbbb3`.`permiso` (`idpermiso`, `nombrepermiso`, `descripcionpermiso`, `idrecurso`, `urlpaginaweb`, `iconpermiso`) VALUES (26, 'Escenarios', NULL, 14, 'index.php/templates/escenarios', NULL);
...
INSERT INTO `enidserv_eniddbbbb3`.`perfil_permiso` (`idperfil`, `idpermiso`) VALUES (3, 26);
INSERT INTO `enidserv_eniddbbbb3`.`perfil_permiso` (`idperfil`, `idpermiso`) VALUES (4, 26);
INSERT INTO `enidserv_eniddbbbb3`.`perfil_permiso` (`idperfil`, `idpermiso`) VALUES (5, 26);
...
START TRANSACTION;
USE `enidserv_eniddbbbb3`;
INSERT INTO `enidserv_eniddbbbb3`.`contacto` (`idcontacto`, `nombre`, `organizacion`, `tel`, `movil`, `correo`, `direccion`, `status`, `fecha_registro`, `tipo`, `idusuario`, `nota`, `pagina_web`, `pagina_fb`, `pagina_tw`, `correo_alterno`, `extension`) VALUES (1, 'monica  soto garcia', NULL, '7151214957', NULL, 'monica@hotmail.com', '  AV. INDEPENDENCIA N0.677  COL. LA PIRAGUA TUXTEPEC', 'Contacto disponible para ser usado', NULL, 'Proveedor', 3, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `enidserv_eniddbbbb3`.`contacto` (`idcontacto`, `nombre`, `organizacion`, `tel`, `movil`, `correo`, `direccion`, `status`, `fecha_registro`, `tipo`, `idusuario`, `nota`, `pagina_web`, `pagina_fb`, `pagina_tw`, `correo_alterno`, `extension`) VALUES (2, 'lorenzo  gordial araiza', NULL, '3334551953', NULL, 'dr.lorenzo@gmail.com', 'AV. INDEPENDENCIA NO. 241   COL. CENTRO TUXTEPEC  68300   ', 'Contacto disponible para ser usado', NULL, 'Proveedor', 3, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `enidserv_eniddbbbb3`.`contacto` (`idcontacto`, `nombre`, `organizacion`, `tel`, `movil`, `correo`, `direccion`, `status`, `fecha_registro`, `tipo`, `idusuario`, `nota`, `pagina_web`, `pagina_fb`, `pagina_tw`, `correo_alterno`, `extension`) VALUES (3, 'leocaria  tamayo quiroz', NULL, '3349594021', NULL, 'leokarr122@hotmail.com', '  AV. 5 DE MAYO NO 1100-A   CENTRO TUXTEPEC   68300   ', 'Contacto disponible para ser usado', NULL, 'Proveedor', 3, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `enidserv_eniddbbbb3`.`contacto` (`idcontacto`, `nombre`, `organizacion`, `tel`, `movil`, `correo`, `direccion`, `status`, `fecha_registro`, `tipo`, `idusuario`, `nota`, `pagina_web`, `pagina_fb`, `pagina_tw`, `correo_alterno`, `extension`) VALUES (4, 'patricia  moreno hernandez', NULL, '3310263136', NULL, 'pnoo120487@live.com.mx', '   AV. 20 DE NOVIEMBRE NO.1024   COL.CENTRO  68300   ', 'Contacto disponible para ser usado', NULL, 'Proveedor', 3, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `enidserv_eniddbbbb3`.`contacto` (`idcontacto`, `nombre`, `organizacion`, `tel`, `movil`, `correo`, `direccion`, `status`, `fecha_registro`, `tipo`, `idusuario`, `nota`, `pagina_web`, `pagina_fb`, `pagina_tw`, `correo_alterno`, `extension`) VALUES (5, 'fimitrio  medina mejia', NULL, '3317472403', NULL, 'fisilicapolanco@hotmail.com', '  CALLE MATAMOROS NO.280  COL. CENTRO TUXTEPEC  68300   ', 'Contacto disponible para ser usado', NULL, 'Proveedor', 3, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `enidserv_eniddbbbb3`.`contacto` (`idcontacto`, `nombre`, `organizacion`, `tel`, `movil`, `correo`, `direccion`, `status`, `fecha_registro`, `tipo`, `idusuario`, `nota`, `pagina_web`, `pagina_fb`, `pagina_tw`, `correo_alterno`, `extension`) VALUES (6, 'ricardo constantino antonio calva', NULL, '5556000096', NULL, 'ricardoccr@live.com', '   AV.INDEPENDENCIA NO. 574  COL. CENTRO TUXTEPEC  68300   ', 'Contacto disponible para ser usado', NULL, 'Proveedor', 3, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `enidserv_eniddbbbb3`.`contacto` (`idcontacto`, `nombre`, `organizacion`, `tel`, `movil`, `correo`, `direccion`, `status`, `fecha_registro`, `tipo`, `idusuario`, `nota`, `pagina_web`, `pagina_fb`, `pagina_tw`, `correo_alterno`, `extension`) VALUES (7, 'david  velazquez carrillo', NULL, '3319557839', NULL, 'dvc_airam@hotmail.com', '   AV. 18 DE MARZO ESQ. BLVD.M. AVILA CAMACHO NO. 1372   COL. LAZARO CARDENAS TUXTEPEC   68340   ', 'Contacto disponible para ser usado', NULL, 'Colaborador', 3, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `enidserv_eniddbbbb3`.`contacto` (`idcontacto`, `nombre`, `organizacion`, `tel`, `movil`, `correo`, `direccion`, `status`, `fecha_registro`, `tipo`, `idusuario`, `nota`, `pagina_web`, `pagina_fb`, `pagina_tw`, `correo_alterno`, `extension`) VALUES (8, 'lillian del rocio de la parra gonzalez', NULL, '3315248491', NULL, 'lilianher911@gmail.com', '   AV. INDEPENDENCIA N0.670  COL. CENTRO TUXTEPEC', 'Contacto disponible para ser usado', NULL, 'Colaborador', 3, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `enidserv_eniddbbbb3`.`contacto` (`idcontacto`, `nombre`, `organizacion`, `tel`, `movil`, `correo`, `direccion`, `status`, `fecha_registro`, `tipo`, `idusuario`, `nota`, `pagina_web`, `pagina_fb`, `pagina_tw`, `correo_alterno`, `extension`) VALUES (9, 'mauricio  españa trinidad', NULL, '3315603228', NULL, 'trinidad_1_lo12@hotmail.com', '   20 DE NOVIEMBRE NO. 955   CENTRO  68300   ', 'Contacto disponible para ser usado', NULL, 'Colaborador', 3, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `enidserv_eniddbbbb3`.`contacto` (`idcontacto`, `nombre`, `organizacion`, `tel`, `movil`, `correo`, `direccion`, `status`, `fecha_registro`, `tipo`, `idusuario`, `nota`, `pagina_web`, `pagina_fb`, `pagina_tw`, `correo_alterno`, `extension`) VALUES (10, 'luis armando gonzalez perez', NULL, '5577118051', NULL, 'loica765@gmail.com', '   AV. LIBERTAD NO. 56   COL. CENTRO TUXTEPEC  68300', 'Contacto disponible para ser usado', NULL, 'Colaborador', 3, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `enidserv_eniddbbbb3`.`contacto` (`idcontacto`, `nombre`, `organizacion`, `tel`, `movil`, `correo`, `direccion`, `status`, `fecha_registro`, `tipo`, `idusuario`, `nota`, `pagina_web`, `pagina_fb`, `pagina_tw`, `correo_alterno`, `extension`) VALUES (11, 'maria guadalupe rodriguez ortega', NULL, '5552771621', NULL, 'maria_oo1151@homail.com', '   AV.INDEPEND.NO. 1065  COL. LA PIRAGUA   68380', 'Contacto disponible para ser usado', NULL, 'Colaborador', 3, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `enidserv_eniddbbbb3`.`contacto` (`idcontacto`, `nombre`, `organizacion`, `tel`, `movil`, `correo`, `direccion`, `status`, `fecha_registro`, `tipo`, `idusuario`, `nota`, `pagina_web`, `pagina_fb`, `pagina_tw`, `correo_alterno`, `extension`) VALUES (12, 'luis  zapata arguello', NULL, '2381203542', NULL, 'liogt6y_er@hotmail.com', '   CALLE MORELOS NO.426  COL. CENTRO TUXTEPEC  68300   ', 'Contacto disponible para ser usado', NULL, 'Contacto Comercial', 3, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `enidserv_eniddbbbb3`.`contacto` (`idcontacto`, `nombre`, `organizacion`, `tel`, `movil`, `correo`, `direccion`, `status`, `fecha_registro`, `tipo`, `idusuario`, `nota`, `pagina_web`, `pagina_fb`, `pagina_tw`, `correo_alterno`, `extension`) VALUES (13, 'jose manuel saucedo lopez', NULL, '3312699458', NULL, 'loseuigiarma@hotmail.com', '20 DE NOVIEMBRE NO. 1081   CENTRO  68300   ', 'Contacto disponible para ser usado', NULL, 'Contacto Comercial', 3, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `enidserv_eniddbbbb3`.`contacto` (`idcontacto`, `nombre`, `organizacion`, `tel`, `movil`, `correo`, `direccion`, `status`, `fecha_registro`, `tipo`, `idusuario`, `nota`, `pagina_web`, `pagina_fb`, `pagina_tw`, `correo_alterno`, `extension`) VALUES (14, 'jose antonio alferes santos', NULL, '3334530354', NULL, 'jaas@gmail.com', '   CALLE MATAMOROS NO. 40  COL. CENTRO TUXTEPEC  68300   ', 'Contacto disponible para ser usado', NULL, 'Contacto Comercial', 3, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `enidserv_eniddbbbb3`.`contacto` (`idcontacto`, `nombre`, `organizacion`, `tel`, `movil`, `correo`, `direccion`, `status`, `fecha_registro`, `tipo`, `idusuario`, `nota`, `pagina_web`, `pagina_fb`, `pagina_tw`, `correo_alterno`, `extension`) VALUES (15, 'jose edgar hernandez luz', NULL, '5583823327', NULL, 'jh_231901@outlook.com', '   BLVD. MANUEL AVILA CAMACHO 435  MARIA LUISA TUXTEPEC  68320   ', 'Contacto disponible para ser usado', NULL, 'Contacto Comercial', 3, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `enidserv_eniddbbbb3`.`contacto` (`idcontacto`, `nombre`, `organizacion`, `tel`, `movil`, `correo`, `direccion`, `status`, `fecha_registro`, `tipo`, `idusuario`, `nota`, `pagina_web`, `pagina_fb`, `pagina_tw`, `correo_alterno`, `extension`) VALUES (16, 'miguel angel panuco ayala', NULL, '5513261681', NULL, 'migue_gezzy.96@gmail.com', '   AV. 20 DE NOVIEMBRE NO. 1105 ESQ.OCAMPO   COL. LA PIRAGUA TUXTEPEC  68380   ', 'Contacto disponible para ser usado', NULL, 'Contacto Comercial', 3, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `enidserv_eniddbbbb3`.`contacto` (`idcontacto`, `nombre`, `organizacion`, `tel`, `movil`, `correo`, `direccion`, `status`, `fecha_registro`, `tipo`, `idusuario`, `nota`, `pagina_web`, `pagina_fb`, `pagina_tw`, `correo_alterno`, `extension`) VALUES (17, 'carlos martin guzman rodriguez', NULL, '5527425070', NULL, 'skate_toxina@hotmail.com', 'AV. JESUS CARRANZA NO. 123  COL. LAZARO CARDENAZ TUXTEPEC   68340   ', 'Contacto disponible para ser usado', NULL, 'Cliente', 3, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `enidserv_eniddbbbb3`.`contacto` (`idcontacto`, `nombre`, `organizacion`, `tel`, `movil`, `correo`, `direccion`, `status`, `fecha_registro`, `tipo`, `idusuario`, `nota`, `pagina_web`, `pagina_fb`, `pagina_tw`, `correo_alterno`, `extension`) VALUES (18, 'cruz maria velazquez carrion', NULL, '5555174618', NULL, 'cruz.carrion@live.com.mx', '  AV. JESUS CARRANZA NO. 123  COL. LAZARO CARDENAZ TUXTEPEC   68340   ', 'Contacto disponible para ser usado', NULL, 'Cliente', 3, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `enidserv_eniddbbbb3`.`contacto` (`idcontacto`, `nombre`, `organizacion`, `tel`, `movil`, `correo`, `direccion`, `status`, `fecha_registro`, `tipo`, `idusuario`, `nota`, `pagina_web`, `pagina_fb`, `pagina_tw`, `correo_alterno`, `extension`) VALUES (19, 'luis alberto peralta barcenas', NULL, '56076247', NULL, 'edel_barcenas@hotmail.com', '  PROLONG. INDEPENDENCIA NO. 2237   COL. OAXACA TUXTEPEC  68350', 'Contacto disponible para ser usado', NULL, 'Cliente', 3, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `enidserv_eniddbbbb3`.`contacto` (`idcontacto`, `nombre`, `organizacion`, `tel`, `movil`, `correo`, `direccion`, `status`, `fecha_registro`, `tipo`, `idusuario`, `nota`, `pagina_web`, `pagina_fb`, `pagina_tw`, `correo_alterno`, `extension`) VALUES (20, 'maria de los angeles elena preciado venegas', NULL, '5531510331', NULL, 'vanegas_122@gmail.com', '  CALLE ALDAMA NO.233-A   COL.CENTRO  68300   ', 'Contacto disponible para ser usado', NULL, 'Cliente', 3, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `enidserv_eniddbbbb3`.`contacto` (`idcontacto`, `nombre`, `organizacion`, `tel`, `movil`, `correo`, `direccion`, `status`, `fecha_registro`, `tipo`, `idusuario`, `nota`, `pagina_web`, `pagina_fb`, `pagina_tw`, `correo_alterno`, `extension`) VALUES (21, 'tania nayeli montoya sierra', NULL, '5515391025', NULL, 'tania.nayeli.montoya.sierra@homail.com', '   INDEPENDENCIA NO. 569 B   CENTRO  68300   ', 'Contacto disponible para ser usado', NULL, 'Cliente', 3, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `enidserv_eniddbbbb3`.`contacto` (`idcontacto`, `nombre`, `organizacion`, `tel`, `movil`, `correo`, `direccion`, `status`, `fecha_registro`, `tipo`, `idusuario`, `nota`, `pagina_web`, `pagina_fb`, `pagina_tw`, `correo_alterno`, `extension`) VALUES (22, 'luis miguel torres manzo', NULL, '5539185152', NULL, 'tmanzo_98@yahoo.com.mx', '  AV. FERROCARRIL S/N.  COL. CENTRO PUEBLO NUEVO. PAPALOAPAN  68441   ', 'Contacto disponible para ser usado', NULL, 'Contacto personal', 3, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `enidserv_eniddbbbb3`.`contacto` (`idcontacto`, `nombre`, `organizacion`, `tel`, `movil`, `correo`, `direccion`, `status`, `fecha_registro`, `tipo`, `idusuario`, `nota`, `pagina_web`, `pagina_fb`, `pagina_tw`, `correo_alterno`, `extension`) VALUES (23, 'ramon  casillas mojarro', NULL, '5518384897', NULL, 'rcmaipa69@hotmail.com', '  MATAMOROS No. 138   CENTRO TUXPEC   68300   ', 'Contacto disponible para ser usado', NULL, 'Contacto personal', 3, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `enidserv_eniddbbbb3`.`contacto` (`idcontacto`, `nombre`, `organizacion`, `tel`, `movil`, `correo`, `direccion`, `status`, `fecha_registro`, `tipo`, `idusuario`, `nota`, `pagina_web`, `pagina_fb`, `pagina_tw`, `correo_alterno`, `extension`) VALUES (24, 'pedro  villaneda marquez', NULL, '5530751218', NULL, 'pilarvalencia@gmail.com', '   AV. 20 DE NOVIEMBRE No. 1037  CENTRO TUXTEPEC   68380   ', 'Contacto disponible para ser usado', NULL, 'Contacto personal', 3, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `enidserv_eniddbbbb3`.`contacto` (`idcontacto`, `nombre`, `organizacion`, `tel`, `movil`, `correo`, `direccion`, `status`, `fecha_registro`, `tipo`, `idusuario`, `nota`, `pagina_web`, `pagina_fb`, `pagina_tw`, `correo_alterno`, `extension`) VALUES (25, 'jesus  mesa vazques', NULL, '5568344206', NULL, 'jethzavaqla83@gmail.com', '  AV. 20 DE NOVIEMBRE NO. 1139-B  COL.CENTRO TUXTEPEC   68300   ', 'Contacto disponible para ser usado', NULL, 'Contacto personal', 3, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `enidserv_eniddbbbb3`.`contacto` (`idcontacto`, `nombre`, `organizacion`, `tel`, `movil`, `correo`, `direccion`, `status`, `fecha_registro`, `tipo`, `idusuario`, `nota`, `pagina_web`, `pagina_fb`, `pagina_tw`, `correo_alterno`, `extension`) VALUES (26, 'catalina mireya trejo pichardo', NULL, '5564153568', NULL, 'pichardo@gmail.com', '  CALLE MORELOS NO. 330 INT.2   COL.CENTRO TUXTEPEC   68300   ', 'Contacto disponible para ser usado', NULL, 'Contacto personal', 3, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `enidserv_eniddbbbb3`.`contacto` (`idcontacto`, `nombre`, `organizacion`, `tel`, `movil`, `correo`, `direccion`, `status`, `fecha_registro`, `tipo`, `idusuario`, `nota`, `pagina_web`, `pagina_fb`, `pagina_tw`, `correo_alterno`, `extension`) VALUES (27, 'ana laura cruz martinez', NULL, '5560416505', NULL, 'ana.laura.cruz.martinez_nys@hotmail.com', '  AV. 5 DE MAYO NO. 1401  COL. CENTRO   68300   ', 'Contacto disponible para ser usado', NULL, 'Artista', 3, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `enidserv_eniddbbbb3`.`contacto` (`idcontacto`, `nombre`, `organizacion`, `tel`, `movil`, `correo`, `direccion`, `status`, `fecha_registro`, `tipo`, `idusuario`, `nota`, `pagina_web`, `pagina_fb`, `pagina_tw`, `correo_alterno`, `extension`) VALUES (28, 'manuel alejandro olivares brito', NULL, '5555956414', NULL, 'maobao7@hotmail.com', '  AV. 20 DE NOVIEMBRE ESQ.EMILIANO ZAPATA S/N   COL. CENTRO   68300   ', 'Contacto disponible para ser usado', NULL, 'Artista', 3, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `enidserv_eniddbbbb3`.`contacto` (`idcontacto`, `nombre`, `organizacion`, `tel`, `movil`, `correo`, `direccion`, `status`, `fecha_registro`, `tipo`, `idusuario`, `nota`, `pagina_web`, `pagina_fb`, `pagina_tw`, `correo_alterno`, `extension`) VALUES (29, 'mario alberto corona inclan', NULL, '5532436635', NULL, 'maci_norma1251@hotmail.com', '   AV. LIBERTAD NO. 1207   COL. CENTRO   68300', 'Contacto disponible para ser usado', NULL, 'Artista', 3, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `enidserv_eniddbbbb3`.`contacto` (`idcontacto`, `nombre`, `organizacion`, `tel`, `movil`, `correo`, `direccion`, `status`, `fecha_registro`, `tipo`, `idusuario`, `nota`, `pagina_web`, `pagina_fb`, `pagina_tw`, `correo_alterno`, `extension`) VALUES (30, 'siria lizeth herrera aguilar', NULL, '5537098560', NULL, 'blackpanther04@hotmail.com', '  AV. ALFONSO CASO NO. 15   CENTRO TUXTEPEC   70215   ', 'Contacto disponible para ser usado', NULL, 'Artista', 3, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `enidserv_eniddbbbb3`.`contacto` (`idcontacto`, `nombre`, `organizacion`, `tel`, `movil`, `correo`, `direccion`, `status`, `fecha_registro`, `tipo`, `idusuario`, `nota`, `pagina_web`, `pagina_fb`, `pagina_tw`, `correo_alterno`, `extension`) VALUES (31, 'raul alfonso gonzalez melendez', NULL, '5515400128', NULL, 'mel_bas_tida@hotmail.com', '  CALLE ALDAMA NO.70  CENTRO TUXTEPEC   68300   ', 'Contacto disponible para ser usado', NULL, 'Artista', 3, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `enidserv_eniddbbbb3`.`contacto` (`idcontacto`, `nombre`, `organizacion`, `tel`, `movil`, `correo`, `direccion`, `status`, `fecha_registro`, `tipo`, `idusuario`, `nota`, `pagina_web`, `pagina_fb`, `pagina_tw`, `correo_alterno`, `extension`) VALUES (32, 'maria xochitl perea morales', NULL, '5565861859', NULL, 'xoch_ag@gmial.com', '  AV. 20 DE NOVIEMBRE NO. 1960  COL.CENTRO TUXTEPEC.  68300   ', 'Contacto disponible para ser usado', NULL, 'Patrocinador', 3, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `enidserv_eniddbbbb3`.`contacto` (`idcontacto`, `nombre`, `organizacion`, `tel`, `movil`, `correo`, `direccion`, `status`, `fecha_registro`, `tipo`, `idusuario`, `nota`, `pagina_web`, `pagina_fb`, `pagina_tw`, `correo_alterno`, `extension`) VALUES (33, 'maria isidra ortiz tarazua', NULL, '5553237801', NULL, 'tarazua_1520@hotmail.com', '  INDEPENDENCIA 623   CENTRO  68300   ', 'Contacto disponible para ser usado', NULL, 'Patrocinador', 3, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `enidserv_eniddbbbb3`.`contacto` (`idcontacto`, `nombre`, `organizacion`, `tel`, `movil`, `correo`, `direccion`, `status`, `fecha_registro`, `tipo`, `idusuario`, `nota`, `pagina_web`, `pagina_fb`, `pagina_tw`, `correo_alterno`, `extension`) VALUES (34, 'luis enrique larrea rivera', NULL, '5533775865', NULL, 'lelr13@hotmail.com', '  KM.5 CARRET.TUX-PTE. CARACOL  TUXTEPEC.   68310   ', 'Contacto disponible para ser usado', NULL, 'Patrocinador', 3, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `enidserv_eniddbbbb3`.`contacto` (`idcontacto`, `nombre`, `organizacion`, `tel`, `movil`, `correo`, `direccion`, `status`, `fecha_registro`, `tipo`, `idusuario`, `nota`, `pagina_web`, `pagina_fb`, `pagina_tw`, `correo_alterno`, `extension`) VALUES (35, 'silvia irene martinez nuñez', NULL, '5522951469', NULL, 'silvia_mimñ_jt@hotmail.com', '   AV. INDEPENDENCIA NO 511 A  CENTRO TUXTEPEC   68300   ', 'Contacto disponible para ser usado', NULL, 'Patrocinador', 3, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `enidserv_eniddbbbb3`.`contacto` (`idcontacto`, `nombre`, `organizacion`, `tel`, `movil`, `correo`, `direccion`, `status`, `fecha_registro`, `tipo`, `idusuario`, `nota`, `pagina_web`, `pagina_fb`, `pagina_tw`, `correo_alterno`, `extension`) VALUES (36, 'carlos domingo sandoval morales', NULL, '5544725282', NULL, 'cadsamd@hotmail.com', '  KM 3.5 CARRETERA TUXTEPEC CD. ALEMAN  FRACCIONAMIENTO COSTA VERDE   68310   ', 'Contacto disponible para ser usado', NULL, 'Patrocinador', 3, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `enidserv_eniddbbbb3`.`contacto` (`idcontacto`, `nombre`, `organizacion`, `tel`, `movil`, `correo`, `direccion`, `status`, `fecha_registro`, `tipo`, `idusuario`, `nota`, `pagina_web`, `pagina_fb`, `pagina_tw`, `correo_alterno`, `extension`) VALUES (37, 'luciana cristina renteria romero', NULL, '5559137222', NULL, 'g.g_13@hotmail.com', '  AV. REFORMA NO.587  COL.EL CASTILLO   68360   ', 'Contacto disponible para ser usado', NULL, 'Patrocinador', 3, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `enidserv_eniddbbbb3`.`contacto` (`idcontacto`, `nombre`, `organizacion`, `tel`, `movil`, `correo`, `direccion`, `status`, `fecha_registro`, `tipo`, `idusuario`, `nota`, `pagina_web`, `pagina_fb`, `pagina_tw`, `correo_alterno`, `extension`) VALUES (38, 'juan pablo guiterrez ayala', NULL, '3318866115', NULL, 'romero_an_chavid@hotmail.com', '  AV. INDEPENDENCIA NO. 377   COL. CENTRO TUXTEPEC  68300   ', 'Contacto disponible para ser usado', NULL, 'Productora', 3, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `enidserv_eniddbbbb3`.`contacto` (`idcontacto`, `nombre`, `organizacion`, `tel`, `movil`, `correo`, `direccion`, `status`, `fecha_registro`, `tipo`, `idusuario`, `nota`, `pagina_web`, `pagina_fb`, `pagina_tw`, `correo_alterno`, `extension`) VALUES (39, 'kiabet anay rolon iñiguez', NULL, '6143447545', NULL, 'kiabet_md@gmail.com', '  AV. INDEPENDENCIA NO. 727   COL. CENTRO TUXTEPEC  68300   ', 'Contacto disponible para ser usado', NULL, 'Productora', 3, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `enidserv_eniddbbbb3`.`contacto` (`idcontacto`, `nombre`, `organizacion`, `tel`, `movil`, `correo`, `direccion`, `status`, `fecha_registro`, `tipo`, `idusuario`, `nota`, `pagina_web`, `pagina_fb`, `pagina_tw`, `correo_alterno`, `extension`) VALUES (40, 'julio cesar rojas pineda', NULL, '9983035654', NULL, 'julio_p@hotmail.com', '   PROLONG.INDEPENDENCIA NO.468-B  COL.OAXACA  68360   ', 'Contacto disponible para ser usado', NULL, 'Productora', 3, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `enidserv_eniddbbbb3`.`contacto` (`idcontacto`, `nombre`, `organizacion`, `tel`, `movil`, `correo`, `direccion`, `status`, `fecha_registro`, `tipo`, `idusuario`, `nota`, `pagina_web`, `pagina_fb`, `pagina_tw`, `correo_alterno`, `extension`) VALUES (41, 'miguel angel carrillo candia', NULL, '9983033598', NULL, 'a.cando.en@gmail.com', '  CALLE GUERRERO ESQ. MURO BLVD.  COL. CENTRO   68300   ', 'Contacto disponible para ser usado', NULL, 'Productora', 3, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `enidserv_eniddbbbb3`.`contacto` (`idcontacto`, `nombre`, `organizacion`, `tel`, `movil`, `correo`, `direccion`, `status`, `fecha_registro`, `tipo`, `idusuario`, `nota`, `pagina_web`, `pagina_fb`, `pagina_tw`, `correo_alterno`, `extension`) VALUES (42, 'tania isela beltran perez', NULL, '9983011190', NULL, 'taryz26@gmail.com', '  BLVD.BENITO JUAREZ NO. 42-C   COL.COSTA VERDE   68310   ', 'Contacto disponible para ser usado', NULL, 'Productora', 3, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `enidserv_eniddbbbb3`.`contacto` (`idcontacto`, `nombre`, `organizacion`, `tel`, `movil`, `correo`, `direccion`, `status`, `fecha_registro`, `tipo`, `idusuario`, `nota`, `pagina_web`, `pagina_fb`, `pagina_tw`, `correo_alterno`, `extension`) VALUES (43, 'daniela paola tobias flores', NULL, '9982936912', NULL, 'tob_daniela68.ap@gmail.com', '   AV. MANCILLA ESQ. ALDAMA S/N.   COL. LAZARO CARDENAS TUXTEPEC   68340   ', 'Contacto disponible para ser usado', NULL, 'Contacto Comercial', 3, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `enidserv_eniddbbbb3`.`contacto` (`idcontacto`, `nombre`, `organizacion`, `tel`, `movil`, `correo`, `direccion`, `status`, `fecha_registro`, `tipo`, `idusuario`, `nota`, `pagina_web`, `pagina_fb`, `pagina_tw`, `correo_alterno`, `extension`) VALUES (44, 'norma patricia hernandez olivares', NULL, '9982424661', NULL, 'oli_r12@hotmail.com', '  KM.2 CARR.FEDERAL TUX-OAXACA.   EX-HACIENDA EL YUCAL  68310   ', 'Contacto disponible para ser usado', NULL, 'Contacto Comercial', 3, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `enidserv_eniddbbbb3`.`contacto` (`idcontacto`, `nombre`, `organizacion`, `tel`, `movil`, `correo`, `direccion`, `status`, `fecha_registro`, `tipo`, `idusuario`, `nota`, `pagina_web`, `pagina_fb`, `pagina_tw`, `correo_alterno`, `extension`) VALUES (45, 'teodoro enrique pino leal', NULL, '9982329107', NULL, 'pino_l_memo@hotmail.com', '  AV. INDEPENDENCIA NO. 643 (425)   COL. CENTRO TUXTEPEC  68300   ', 'Contacto disponible para ser usado', NULL, 'Contacto Comercial', 3, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `enidserv_eniddbbbb3`.`contacto` (`idcontacto`, `nombre`, `organizacion`, `tel`, `movil`, `correo`, `direccion`, `status`, `fecha_registro`, `tipo`, `idusuario`, `nota`, `pagina_web`, `pagina_fb`, `pagina_tw`, `correo_alterno`, `extension`) VALUES (46, 'jose luis melgarejo gonzalez', NULL, '9982152580', NULL, 'jlmmg858@gmail.com', '  C. ZARAGOZA NO. 329   CENTRO  68300   ', 'Contacto disponible para ser usado', NULL, 'Contacto Comercial', 3, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `enidserv_eniddbbbb3`.`contacto` (`idcontacto`, `nombre`, `organizacion`, `tel`, `movil`, `correo`, `direccion`, `status`, `fecha_registro`, `tipo`, `idusuario`, `nota`, `pagina_web`, `pagina_fb`, `pagina_tw`, `correo_alterno`, `extension`) VALUES (47, 'jose javier perez flores', NULL, '9982073343', NULL, 'jjperes_2er@gmail.com', '   C. MARINA HERNANDEZ N. 5  COL. MARIA LUISA TUXTEPEC   68320   ', 'Contacto disponible para ser usado', NULL, 'Contacto Comercial', 3, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `enidserv_eniddbbbb3`.`contacto` (`idcontacto`, `nombre`, `organizacion`, `tel`, `movil`, `correo`, `direccion`, `status`, `fecha_registro`, `tipo`, `idusuario`, `nota`, `pagina_web`, `pagina_fb`, `pagina_tw`, `correo_alterno`, `extension`) VALUES (48, 'julio cristian romero tenorio', NULL, '9982043571', NULL, 'julio_cristian_romero@gmail.com', '  AV. INDEPENDENCIA NO. 405   CENTRO  68300   ', 'Contacto disponible para ser usado', NULL, 'Colaborador', 3, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `enidserv_eniddbbbb3`.`contacto` (`idcontacto`, `nombre`, `organizacion`, `tel`, `movil`, `correo`, `direccion`, `status`, `fecha_registro`, `tipo`, `idusuario`, `nota`, `pagina_web`, `pagina_fb`, `pagina_tw`, `correo_alterno`, `extension`) VALUES (49, 'jesus alberto garcia pedro', NULL, '9982026782', NULL, 'jszn1406@gmail.com', '  AV. 5 DE MAYO ESQ. MATAMOROS NO 1070  CENTRO TUXTEPEC   68300   ', 'Contacto disponible para ser usado', NULL, 'Colaborador', 3, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `enidserv_eniddbbbb3`.`contacto` (`idcontacto`, `nombre`, `organizacion`, `tel`, `movil`, `correo`, `direccion`, `status`, `fecha_registro`, `tipo`, `idusuario`, `nota`, `pagina_web`, `pagina_fb`, `pagina_tw`, `correo_alterno`, `extension`) VALUES (50, 'ivan pavel escamilla garcia', NULL, '9982013131', NULL, 'abg.j.garcia@gmail.com', '   BLVD. BENITO JUAREZ NO 568  CENTRO TUXTEPEC   68300   ', 'Contacto disponible para ser usado', NULL, 'Colaborador', 3, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `enidserv_eniddbbbb3`.`contacto` (`idcontacto`, `nombre`, `organizacion`, `tel`, `movil`, `correo`, `direccion`, `status`, `fecha_registro`, `tipo`, `idusuario`, `nota`, `pagina_web`, `pagina_fb`, `pagina_tw`, `correo_alterno`, `extension`) VALUES (51, 'victor hugo valencia fernandez', NULL, '9982001476', NULL, 'vic_djz@hotmail.com', '   AV. 20 DE NOVIEMBRE NO 822  CENTRO TUXTEPEC   68300   ', 'Contacto disponible para ser usado', NULL, 'Colaborador', 3, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `enidserv_eniddbbbb3`.`contacto` (`idcontacto`, `nombre`, `organizacion`, `tel`, `movil`, `correo`, `direccion`, `status`, `fecha_registro`, `tipo`, `idusuario`, `nota`, `pagina_web`, `pagina_fb`, `pagina_tw`, `correo_alterno`, `extension`) VALUES (52, 'maria del pilar rivera aguillon', NULL, '9932327172', NULL, 'mari_amos531@gmail.com', '   CALLE PRINCIPAL S/N.  SN.MIGUEL SOYALTEPEC(TEMASCAL   68430   ', 'Contacto disponible para ser usado', NULL, 'Colaborador', 3, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `enidserv_eniddbbbb3`.`contacto` (`idcontacto`, `nombre`, `organizacion`, `tel`, `movil`, `correo`, `direccion`, `status`, `fecha_registro`, `tipo`, `idusuario`, `nota`, `pagina_web`, `pagina_fb`, `pagina_tw`, `correo_alterno`, `extension`) VALUES (53, 'sergio  castillo nuñez', NULL, '9932323181', NULL, 'serlpako14@yahoo.com', 'CARR. A OJITLAN NO. 951-A   COL. 5 DE MAYO TUXTEPEC   68360   ', 'Contacto disponible para ser usado', NULL, 'Patrocinador', 3, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `enidserv_eniddbbbb3`.`contacto` (`idcontacto`, `nombre`, `organizacion`, `tel`, `movil`, `correo`, `direccion`, `status`, `fecha_registro`, `tipo`, `idusuario`, `nota`, `pagina_web`, `pagina_fb`, `pagina_tw`, `correo_alterno`, `extension`) VALUES (54, 'sandra guadalupe cortes jimenez', NULL, '9932202393', NULL, 'correo_jimenez@gmail.com', '   AV. INDENDENCIA NO. 1381  LA PIRAGUA  68380   ', 'Contacto disponible para ser usado', NULL, 'Patrocinador', 3, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `enidserv_eniddbbbb3`.`contacto` (`idcontacto`, `nombre`, `organizacion`, `tel`, `movil`, `correo`, `direccion`, `status`, `fecha_registro`, `tipo`, `idusuario`, `nota`, `pagina_web`, `pagina_fb`, `pagina_tw`, `correo_alterno`, `extension`) VALUES (55, 'pedro  herrera cortina', NULL, '9932200234', NULL, 'cortina@gmail.com', '   AV. INDEPENDENCIA NO. 346   CENTRO  68300   ', 'Contacto disponible para ser usado', NULL, 'Patrocinador', 3, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `enidserv_eniddbbbb3`.`contacto` (`idcontacto`, `nombre`, `organizacion`, `tel`, `movil`, `correo`, `direccion`, `status`, `fecha_registro`, `tipo`, `idusuario`, `nota`, `pagina_web`, `pagina_fb`, `pagina_tw`, `correo_alterno`, `extension`) VALUES (56, 'hortencia  ramos sanchez', NULL, '9932136299', NULL, 'ramosngf_777@gmail.com', '  AV. MANCILLA ESQ. ALDAMA S/N  LAZARO CARDENAS   68340   ', 'Contacto disponible para ser usado', NULL, 'Patrocinador', 3, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `enidserv_eniddbbbb3`.`contacto` (`idcontacto`, `nombre`, `organizacion`, `tel`, `movil`, `correo`, `direccion`, `status`, `fecha_registro`, `tipo`, `idusuario`, `nota`, `pagina_web`, `pagina_fb`, `pagina_tw`, `correo_alterno`, `extension`) VALUES (57, 'maria elena quiles estrada', NULL, '9932171000', NULL, 'dox._@hotmail.com', '   AV. INDEPENDENCIA NO. 858   COL. CENTRO TUXTEPEC  68300   ', 'Contacto disponible para ser usado', NULL, 'otro', 3, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `enidserv_eniddbbbb3`.`contacto` (`idcontacto`, `nombre`, `organizacion`, `tel`, `movil`, `correo`, `direccion`, `status`, `fecha_registro`, `tipo`, `idusuario`, `nota`, `pagina_web`, `pagina_fb`, `pagina_tw`, `correo_alterno`, `extension`) VALUES (58, 'francisco javier maldonado hernandez', NULL, '9932164117', NULL, 'maldonado_cloks@hotmail.com', '   C. ALDAMA NO. 25  COL.CENTRO TUXTEPEC   68300   ', 'Contacto disponible para ser usado', NULL, 'otro', 3, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `enidserv_eniddbbbb3`.`contacto` (`idcontacto`, `nombre`, `organizacion`, `tel`, `movil`, `correo`, `direccion`, `status`, `fecha_registro`, `tipo`, `idusuario`, `nota`, `pagina_web`, `pagina_fb`, `pagina_tw`, `correo_alterno`, `extension`) VALUES (59, 'gustavo alberto rodriguez pacheco', NULL, '9932158446', NULL, 'rpgaa@hotmail.com', 'AV. INDEPENDENCIA NO 49   CENTRO TUXTEPEC   68300   ', 'Contacto disponible para ser usado', NULL, 'otro', 3, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `enidserv_eniddbbbb3`.`contacto` (`idcontacto`, `nombre`, `organizacion`, `tel`, `movil`, `correo`, `direccion`, `status`, `fecha_registro`, `tipo`, `idusuario`, `nota`, `pagina_web`, `pagina_fb`, `pagina_tw`, `correo_alterno`, `extension`) VALUES (60, 'omar eduardo nuñez escobedo', NULL, '9932150092', NULL, 'oma_ranita_rtm75@gmail.com', '   KM. 2 CARRETERA TUXTEPEC- VALLE NACIONAL  CONJUNTO HABITACIONAL DE CERVECERA  68365   ', 'Contacto disponible para ser usado', NULL, 'otro', 3, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `enidserv_eniddbbbb3`.`contacto` (`idcontacto`, `nombre`, `organizacion`, `tel`, `movil`, `correo`, `direccion`, `status`, `fecha_registro`, `tipo`, `idusuario`, `nota`, `pagina_web`, `pagina_fb`, `pagina_tw`, `correo_alterno`, `extension`) VALUES (61, 'jose de jesus mora nuño', NULL, '9932117518', NULL, 'j.i.s.195954@gmail.com', 'ARTEAGA NO 729   LAZARO CARDENAS TUXTEPEC  68340   ', 'Contacto disponible para ser usado', NULL, 'otro', 3, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `enidserv_eniddbbbb3`.`contacto` (`idcontacto`, `nombre`, `organizacion`, `tel`, `movil`, `correo`, `direccion`, `status`, `fecha_registro`, `tipo`, `idusuario`, `nota`, `pagina_web`, `pagina_fb`, `pagina_tw`, `correo_alterno`, `extension`) VALUES (62, 'luis antonio torres castillo', NULL, '9932110298', NULL, 'zyeklam_tz7@hotmail.com', '   AV. INDEPENDENCIA N. 1282-A   CENTRO  68300   ', 'Contacto disponible para ser usado', NULL, 'otro', 3, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `enidserv_eniddbbbb3`.`contacto` (`idcontacto`, `nombre`, `organizacion`, `tel`, `movil`, `correo`, `direccion`, `status`, `fecha_registro`, `tipo`, `idusuario`, `nota`, `pagina_web`, `pagina_fb`, `pagina_tw`, `correo_alterno`, `extension`) VALUES (63, 'luis alfredo bravo velasco', NULL, '9932104669', NULL, 'bravo_7279@hotmail.com', 'BLVD. BENITO JUAREZ ESQ. AV. 5 DE MAYO NO 670   LA PIRAGUA TUXTEPEC   68380   01 ', 'Contacto disponible para ser usado', NULL, 'otro', 3, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `enidserv_eniddbbbb3`.`contacto` (`idcontacto`, `nombre`, `organizacion`, `tel`, `movil`, `correo`, `direccion`, `status`, `fecha_registro`, `tipo`, `idusuario`, `nota`, `pagina_web`, `pagina_fb`, `pagina_tw`, `correo_alterno`, `extension`) VALUES (64, 'miguel angel almadas grano', NULL, '9932082848', NULL, 'boni-zereo@hotmail.com', '  MATAMOROS NO 350  CENTRO TUXTEPEC   68300   ', 'Contacto disponible para ser usado', NULL, 'otro', 3, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `enidserv_eniddbbbb3`.`contacto` (`idcontacto`, `nombre`, `organizacion`, `tel`, `movil`, `correo`, `direccion`, `status`, `fecha_registro`, `tipo`, `idusuario`, `nota`, `pagina_web`, `pagina_fb`, `pagina_tw`, `correo_alterno`, `extension`) VALUES (65, 'marta patricia diaz garcia', NULL, '9932068227', NULL, 'diaz.midnight@gmail.com', '   KM. 2 CARRETERA TUXTEPEC- VALLE NACIONAL  CONJUNTO HABITACIONAL DE CERVECERA  68365   ', 'Contacto disponible para ser usado', NULL, 'Cliente', 3, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `enidserv_eniddbbbb3`.`contacto` (`idcontacto`, `nombre`, `organizacion`, `tel`, `movil`, `correo`, `direccion`, `status`, `fecha_registro`, `tipo`, `idusuario`, `nota`, `pagina_web`, `pagina_fb`, `pagina_tw`, `correo_alterno`, `extension`) VALUES (66, 'miguel  perez martinez', NULL, '9932064723', NULL, 'for.snopy@outlook.com', '   INDEPENDENCIA NO 1231 A   LA PIRAGUA TUXTEPEC   68320   ', 'Contacto disponible para ser usado', NULL, 'Cliente', 3, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `enidserv_eniddbbbb3`.`contacto` (`idcontacto`, `nombre`, `organizacion`, `tel`, `movil`, `correo`, `direccion`, `status`, `fecha_registro`, `tipo`, `idusuario`, `nota`, `pagina_web`, `pagina_fb`, `pagina_tw`, `correo_alterno`, `extension`) VALUES (67, 'gabriel  perez gonzalez', NULL, '9932063806', NULL, 'gpgonzales@hotmail.com', '   CALLE OCAMPO NO.  COL. CENTRO TUXTEPEC  68300   ', 'Contacto disponible para ser usado', NULL, 'Cliente', 3, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `enidserv_eniddbbbb3`.`contacto` (`idcontacto`, `nombre`, `organizacion`, `tel`, `movil`, `correo`, `direccion`, `status`, `fecha_registro`, `tipo`, `idusuario`, `nota`, `pagina_web`, `pagina_fb`, `pagina_tw`, `correo_alterno`, `extension`) VALUES (68, 'maria esther colin maya', NULL, '9932050850', NULL, 'mardm523784@gmail.com', '  AV INDEPENDENCIA NO 1189  CENTRO  68300   ', 'Contacto disponible para ser usado', NULL, 'Cliente', 3, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `enidserv_eniddbbbb3`.`contacto` (`idcontacto`, `nombre`, `organizacion`, `tel`, `movil`, `correo`, `direccion`, `status`, `fecha_registro`, `tipo`, `idusuario`, `nota`, `pagina_web`, `pagina_fb`, `pagina_tw`, `correo_alterno`, `extension`) VALUES (69, 'luis  sibrian manzano', NULL, '9932011319', NULL, 'lmanzely_doll@hotmail.com', '  BOULEVARD BENITO JUAREZ ESQ. INDEPENDENCIA  LA PIRAGUA  68380   ', 'Contacto disponible para ser usado', NULL, 'Cliente', 3, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `enidserv_eniddbbbb3`.`contacto` (`idcontacto`, `nombre`, `organizacion`, `tel`, `movil`, `correo`, `direccion`, `status`, `fecha_registro`, `tipo`, `idusuario`, `nota`, `pagina_web`, `pagina_fb`, `pagina_tw`, `correo_alterno`, `extension`) VALUES (70, 'carmelo  quezada ochoa', NULL, '9932102100', NULL, 'ochoa54328@gmail.com', '  AV. INDEPENDENCIA NO. 608   COL.CENTRO TUXTEPEC.OAX.  68300   ', 'Contacto disponible para ser usado', NULL, 'otro', 3, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `enidserv_eniddbbbb3`.`contacto` (`idcontacto`, `nombre`, `organizacion`, `tel`, `movil`, `correo`, `direccion`, `status`, `fecha_registro`, `tipo`, `idusuario`, `nota`, `pagina_web`, `pagina_fb`, `pagina_tw`, `correo_alterno`, `extension`) VALUES (71, 'alva luz resendiz guerrero', NULL, '9932067598', NULL, 'liz_resendiz@yahoo.com', '  INDEPENDENCIA No 1655   COL. CENTRO   68300   ', 'Contacto disponible para ser usado', NULL, 'otro', 3, NULL, NULL, NULL, NULL, NULL, NULL);
...
START TRANSACTION;
USE `enidserv_eniddbbbb3`;
INSERT INTO `enidserv_eniddbbbb3`.`punto_venta` (`idpunto_venta`, `razon_social`, `status`, `fecha_registro`, `idempresa`, `descripcion`, `zona`) VALUES (1, 'Taquillas del evento', 'Disponible para todos los colaboradores de la empresa', NULL, 1, NULL, NULL);
INSERT INTO `enidserv_eniddbbbb3`.`punto_venta` (`idpunto_venta`, `razon_social`, `status`, `fecha_registro`, `idempresa`, `descripcion`, `zona`) VALUES (2, 'Patrocinadores del evento', 'Disponible para todos los colaboradores de la empresa', NULL, 1, NULL, NULL);
