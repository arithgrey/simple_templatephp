...
if(!function_exists('invierte_date_time')){
	...
	function display_complete_info($data_accesos){
		...
		foreach ($data_accesos as $row){
			...
			*/
			$delete =  get_td('<i data-toggle="modal" data-target="#confirma-delete-acceso" class="fa  fa-times delete-acceso" id="'.$idacceso.'"  ><i>', '');
		...
		$complete .=  "<em>Publicados: ".$promo_total ."</em>";
		$complete .=  $l;
		return $complete;
