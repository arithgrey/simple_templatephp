              ...
              <div class="panel panel-default" >
                <div class="panel-body" >                    
                    <div class="profile-desk">
                      ...
                      <a href="#pag-2-section" class='la-historia client-history '>
                        <h1>
                        ...
                        <!---->      
                        <hr>
                        <a href="#pag-3-section" class='tu-artista solicita-artista '>
                          <h1>
                            Solicita tu artista
                          </h1>  
                          <span>
...
<!--********************CARGAMOS BLOQUE CUENTAMOS TU HISTORIA*********-->
<?=$this->load->view('empresa/cuentanos_tu_historia');?>
<!--********************TERMINAMOS DE CARGAR BLOQUE CUENTAMOS TU HISTORIA*********-->
