...
class Recursocontroller extends CI_Controller {
	...
	function usuarios($limit=10){
		...
		$data["lista_perfiles"] = create_select($perfiles , "busqueda-perfil" , 'busqueda-perfil form-control' , 'busqueda-perfil' , 'nombreperfil' , 'idperfil');
	...
	function informacioncuenta(){
		...
		$data = $this->validate_user_sesssion("Configuración de la cuenta");					
