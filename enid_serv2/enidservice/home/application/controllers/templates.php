...
class Templates extends CI_Controller {
    ...
    function eventos(){    
        ...
        $data = $this->validate_user_sesssion("Mis plantillas / Eventos");
    ...
    function escenarios(){    
        ...
        $data = $this->validate_user_sesssion("Mis plantillas / Escenarios");
        $id_user = $this->sessionclass->getidusuario();        
        $id_empresa =  $this->sessionclass->getidempresa();           
        $this->dinamic_view_event("plantillas/escenarios" , $data);
