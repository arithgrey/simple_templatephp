$(document).on("ready" , function(){
    ...
    $("#busqueda-perfil").change(function(){
        load_users_cuenta("");
    }); 
...
function load_users_cuenta(filtro){
    ...
    estado =  $("#estatus-filtro").val();
    perfil = $("#busqueda-perfil").val();
    $.get(url, {"filtro": filtro ,  "turno" : turno , "estado" : estado  , "perfil" : perfil } ).done(function( data ){
