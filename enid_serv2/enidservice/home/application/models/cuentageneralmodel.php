...
function getintegrantesinforme($iduser, $integrante , $id_empresa , $limit , $param ='' ){
    ...
    if ($integrante == "0" ){
      ...
      $query_get ="select u.*, p.nombreperfil ,
                  i.idimagen ,     
                  i.nombre_imagen ,
                  i.base_path     ,
                  i.base_path_img 
                  ...
                  left outer join imagen  i on   iu.idimagen = i.idimagen
                  where 
                  idempresa ='".$id_empresa."' " . $filtro_limit;
    ...
    $query_get ="select u.*, p.nombreperfil,
                ...
                u.nombre like '". $integrante."%' and 
                u.turno = '".$param["turno"]."'   and 
                u.status = '".$param["estado"]."' and 
                p.idperfil   = '".$param["perfil"]."'
                ".$filtro_limit;  
