...
DELIMITER $$
USE `enidserv_eniddbbbb3`$$
CREATE PROCEDURE  create_temp_palabra_clave(condicional text  )
BEGIN 
...
SET @tmp_query =  CONCAT('INSERT INTO evento_palabra_clave 
    SELECT  idevento ,  nombre_evento , 1   FROM evento WHERE 1=1 and' ,  @c); 
...
START TRANSACTION;
USE `enidserv_eniddbbbb3`;
INSERT INTO `enidserv_eniddbbbb3`.`usuario` (`idusuario`, `nombre`, `email`, `password`, `fecha_registro`, `idempresa`, `descripcion`, `puesto`, `status`, `apellido_paterno`, `apellido_materno`, `email_alterno`, `tel_contacto`, `tel_contacto_alterno`, `edad`, `numero_empleado`, `inicio_labor`, `fin_labor`, `grupo`, `cargo`, `rfc`, `turno`, `ultima_modificacion`, `descripcion_usuario`, `url_fb`, `url_tw`, `url_www`) VALUES (1, 'arithgrey', 'arithgrey@gmail.com', '870058cbcebe244bce513be539acd6905bca8d99', NULL, 1, NULL, 'Presidente ejecutivo', 'Usuario Activo', 'Medrano', 'Salazar', 'enidservice@gmail.com', 5573355891, 5545444823, 25, NULL, '09:00 AM', '18:00 PM', 'Desarrollo', 'Presidente Ejecutivo', NULL, 'Matutino', NULL, NULL, NULL, NULL, NULL);
INSERT INTO `enidserv_eniddbbbb3`.`usuario` (`idusuario`, `nombre`, `email`, `password`, `fecha_registro`, `idempresa`, `descripcion`, `puesto`, `status`, `apellido_paterno`, `apellido_materno`, `email_alterno`, `tel_contacto`, `tel_contacto_alterno`, `edad`, `numero_empleado`, `inicio_labor`, `fin_labor`, `grupo`, `cargo`, `rfc`, `turno`, `ultima_modificacion`, `descripcion_usuario`, `url_fb`, `url_tw`, `url_www`) VALUES (2, 'estratega test', 'estrategatest@gmail.com', '870058cbcebe244bce513be539acd6905bca8d99', NULL, 1, NULL, 'Presidente ejecutivo', 'Usuario Activo', NULL, NULL, NULL, NULL, NULL, 25, NULL, '09:00 AM', '18:00 PM', 'Desarrollo', 'Presidente Ejecutivo', NULL, 'Matutino', NULL, NULL, NULL, NULL, NULL);
INSERT INTO `enidserv_eniddbbbb3`.`usuario` (`idusuario`, `nombre`, `email`, `password`, `fecha_registro`, `idempresa`, `descripcion`, `puesto`, `status`, `apellido_paterno`, `apellido_materno`, `email_alterno`, `tel_contacto`, `tel_contacto_alterno`, `edad`, `numero_empleado`, `inicio_labor`, `fin_labor`, `grupo`, `cargo`, `rfc`, `turno`, `ultima_modificacion`, `descripcion_usuario`, `url_fb`, `url_tw`, `url_www`) VALUES (3, 'administradortest', 'administradortest@gmail.com', '870058cbcebe244bce513be539acd6905bca8d99', NULL, 1, NULL, 'Administrador', 'Usuario Activo', NULL, NULL, NULL, NULL, NULL, 18, NULL, '09:00 AM', '18:00 PM', NULL, NULL, NULL, 'Matutino', NULL, NULL, NULL, NULL, NULL);
