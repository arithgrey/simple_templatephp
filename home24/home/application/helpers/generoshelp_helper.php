...
function registrados_config($data){
    ...
    $g ="<div class='text-center resultados-busqueda-enid' style='border='1'>";     
    $g .="<h3 style='color:white;'>Géneros musicales </h3>";

    foreach ($data as $row) {
         $g .=  "<span class='genero_registrado' id='".$row["id_genero"]."'>" .$row["genero"]."</span>";    
    }    
    $g .= "</div>";
    return $g;
}
