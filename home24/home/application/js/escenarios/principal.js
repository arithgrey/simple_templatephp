$(document).on("ready" , function(){
	...
	$("#form-artista-tipificacion").submit(function(){
		alert("ok");
		return false;
	});
...
function list_informe_artistas(e){
	...
	$.get(url , {"evento" : evento} ).done(function(data){
		...
		for(var a = 0  in  data ) {					
			...
			url_escenario = now + "index.php/escenario/configuracionavanzada/"+ data[a].id_escenario;
			artistas_list += "<li><a href='"+url_escenario+"'>" + data[a].nombre_artista + "</a></li>";
		}		
