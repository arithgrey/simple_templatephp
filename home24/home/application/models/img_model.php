...
/*************************************************************************************/  
  ...
  function insert_logo_empresa($data, $id_usuario , $id_empresa ){
    ...
    if ($result_exist->num_rows() > 0 ) {
      ...
      $dinamic_query ="update imagen_empresa set id_imagen  = '". $id_imagen. "' where id_empresa = '". $id_empresa."' limit 1";    
  ...
  function insert_principal_escenario_artista($data , $id_usuario , $id_empresa ){    
    ...
    $query_exist = "select * from imagen_artista where id_artista= '". $id_artista . "' limit 3";
    $result_exist =  $this->db->query($query_exist);   
    
    
    if ($result_exist->num_rows() > 0 ) {
     $dinamic_query ="UPDATE imagen_artista SET id_imagen='".$id_imagen."' WHERE id_artista ='". $id_artista ."'  limit 1";    
  ...
  function insert_contacto($data , $id_usuario , $id_empresa ){
    ...
    if ($result_exist->num_rows() > 0 ){
        ...
        $dinamic_query ="update imagen_contacto set  id_imagen= '". $id_imagen."'  WHERE  id_contacto= '". $id_contacto ."' limit 1";    
  ...
  function insert_acceso($data , $id_usuario , $id_empresa ){
    ...
    if ($result_exist->num_rows() > 0 ){
      ...
      $dinamic_query ="UPDATE  imagen_acceso SET id_imagen = '". $id_imagen."'  WHERE id_acceso =  '". $id_acceso ."' limit 1";    
    }else{
