                ...
                <div class="row">
                  ...
                  <div class="col-sm-4 col-md-4 col-lg-4">
                    ...
                    <p style="background : #0EC8DE !important;">
                      <a style='color:white !important' href="<?=base_url('index.php/emp/lahistoria')?>/<?=$evento["idempresa"]?>" class="btn btn-lg btn-gray-transparent btn-animated">
