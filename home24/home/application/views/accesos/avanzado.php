        ...
        <div class="panel ">
            ...
            <div class="panel-body">
                <div class="profile-desk">
                     <h1>
                        Accesos registrados al evento <a href="<?=base_url('index.php/eventos/nuevo/')?>/<?=$id_evento;?>"><?=$nombre_evento;?></a>
                     </h1>                   
...
<?php /*$this->load->view("accesos/accesos_puntos_venta")*/?>
