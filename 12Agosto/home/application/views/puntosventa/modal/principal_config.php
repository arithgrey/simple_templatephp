...
<?=construye_header_modal('punto-venta-descripcion-modal', "Dirección del punto de venta" );?>  
    <form id='form-nota-pv' action="<?=base_url('index.php/api/puntosventa/punto_venta_nota/format/json/')?>">        
        ...
        <input list= 'locaciones' name="nota-punto-venta" id='locacion' class="locacion form-control input-sm" placeholder="Dirección ">        
...
<?=construye_header_modal('editd-punto-venta-modal', " Configuración " );?>      
    ...
    <form class='form-puntos-venta-edit' id="form-puntos-venta-edit" method="post" action="<?=base_url('index.php/api/puntosventa/punto/format/json/')?>">                    
        ...
        <div class="form-group">                
            <input list='lista-locaciones' name="ndescripcion" id="ndescripcion" class="form-control input-sm nlocacion" placeholder="Dirección ">            
        </div>
...
<?=construye_header_modal('contact-modal', " Registrar nuevo " );?>  
    ...
    <form class='form-puntos-venta' id="form-puntos-venta" method="post" action="<?=base_url('index.php/api/puntosventa/punto/format/json/')?>">            
        ...
        <div class="form-group">                        
        <input list='direcciones-disponibles' name="descripcion" id='area_descripcion' class="form-control input-sm contacto_direccion" placeholder="Dirección">        
        </div>    
