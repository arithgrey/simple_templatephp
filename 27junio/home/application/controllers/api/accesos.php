...
class Accesos extends REST_Controller{
    ...
    function nuevo_post(){        
        ...
        $dbrespose = $this->accesosmodel->insert( $nombre_acceso  , $precio , $inicio , $termino , $id_evento , $acceso_tipo,  $id_empresa ,  $id_usuario , $nombre_usuario );
    ...
    function acceso_post(){
        ...
        $id_empresa =  $this->sessionclass->getidempresa();                              
        $dbrespose = $this->accesosmodel->insert( $nombre , $precio  ,  $inicio  , $termino , $id_evento , $tipo , $descripcion , $id_empresa , $id_usuario ,  $nombre_usuario );        
        $this->response($dbrespose);
    }
