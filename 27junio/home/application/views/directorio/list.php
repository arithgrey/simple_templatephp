<?php
		...
		foreach ($contactos as $row) {
			...
			/*
			if ($status ==  "Contacto disponible para ser usado") {
				$status =  "Disponible";
			...
			*/
			...
			$contacto .='<tr>';			
				...
				$contacto .= get_td('<i class="nota-c  fa fa-list-alt"  id="'. $idcontacto.'"  ></i>', ' data-toggle="modal" data-target="#contact-nota"');		 
