                    ...
                    <div class="panel">                  
                      ...
                      <div class="panel-body">
                          ...
                          <ul class="nav nav-tabs menu_contenidos_enid">                                  
                            <li class='generos_musicales_contente' id='generos_musicales_contente'>
                          ...
                          <div class="tab-content">
                            ...
                            <div class="tab-pane" id="portlet_tab1">            
                              ...
                              <span class='politicas-p' id='politicas-p'>
                                <?=show_text_input($data_evento["politicas"] , 250 , "Lo que podría anticiparse como reembolsos o cambios" )?>
                              </span>                              
                            ...
                            <div class="tab-pane" id="portlet_tab3">                      
                              ...
                              <div class='restricciones-p' id='restricciones-p'>
                                <?=show_text_input($data_evento["restricciones"] , 25 , "Lo que se permite en el evento" )?>      
                              </div>                             
                              <div class="form-group">
...
<div class='container'  id="mapgooglemap">          
  ...
  <div>
    ...
    <input id="pac-input" class="controls ubicacioninput form-control input-sm" type="text" placeholder="Ubicación del evento" value="<?=$data_evento['ubicacion']?>">
...
.restricciones-p:hover , .politicas-p:hover , .permitido-p:hover{
  cursor: pointer; 
}
#tematica_section , .tematica_section, #section-articulos-permitidos{
  display: none;
}
.eslogan-input{
  display: none;
