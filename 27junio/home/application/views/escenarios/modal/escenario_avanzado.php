...
<!---->
<?=construye_header_modal('modal-platilla-escenarios', " Tomar contenido " );?>                                  
    ...
    <div class='list-plantilla-escenario' id='list-plantilla-escenario'>
    </div>
    <a href="<?=base_url('index.php/templates/eventos')?>">
        <em>
        Registrar más plantillas, con esta herramienta tendrás listo en cada escenario  textos pre cargados listos para ser utilizado. 
        </em>
    </a>                
<?=construye_footer_modal()?> 
