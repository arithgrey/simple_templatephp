$(document).on("ready", function (){
	...
	$("#generos_musicales_button").click( function(){
		...
		show_section_dinamic_on_click("#busqueda-genero-musical");
		/*Mostramos las flechas dinámicas */
		show_section_dinamic_arrow(".generos_musicales_div" , "#btn-generos" , "fa-caret-down" , "fa-sort-asc" );
...
function update_politicas_evento(e){
	...
	$("#politicas-evento").blur(function(){
		...
		if (nuevotexto != null  ) {	
			...
			$("#alert-politicas-ok").show();
			muestra_alert_segundos("#alert-politicas-ok"); 
...
function update_permitido_evento(e){
	...
	$("#permitido-evento").blur(function(){
		...
		if (nuevotexto != null  ) {	
			...
			$("#alert-permitido-ok").show();
			muestra_alert_segundos("#alert-permitido-ok"); 
...
function updaterestricciones(e){
	...
	$("#restricciones-evento").blur(function(){			
		...
		if (nuevotexto != null  ) {	
			...
			$("#alert-resticciones-ok").show();
			muestra_alert_segundos("#alert-resticciones-ok"); 
...
function update_ubicacion_evento(){
	...
	$("#pac-input").blur(function(){
		...
		actualiza_data(url , data_send);
		$("#alert-locacion-ok").show();
		muestra_alert_segundos("#alert-locacion-ok"); 
...
function update_eslogan_evento(e){
	...
	$("#eslogan-evento").blur(function(){
		...
		if (nuevotexto != null  ) {	
			...
			actualiza_data(url , data_send);
			$("#alert-slogan-ok").show();
			muestra_alert_segundos("#alert-slogan-ok");
...
function update_descripcion_evento_by_template(e){
	...
	load_data_evento( ".descripcion-p" , "#descripcion-evento" , "descripcion_evento" , ".place_description" , "<i class='fa fa-plus'></i> Lo que se vivirá en el evento" , "<i class='fa fa-plus'></i> Lo que se vivirá en el evento");
	$("#alert-ok-plantilla-evento").show();
	muestra_alert_segundos("#alert-ok-plantilla-evento");
...
function record_contenido_evento_template(e){	
	...
	/**/
	complete_alert("#alert-ok-tmp-restricciones");
	complete_alert("#alert-ok-tmp-politicas");
...
function update_fecha_evento(){	
	...
	/*Notificamos al usuario que se efectuó el cambio correctamente */

	complete_alert("#aler-ok-fecha");
