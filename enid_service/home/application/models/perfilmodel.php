...
class perfilmodel extends CI_Model {
    ...
    function getperfildata($id_usuario){
        ...
        $query_get ="SELECT p.idperfil , p.nombreperfil , p.descripcion FROM perfil AS p , 
        usuario_perfil AS up WHERE  up.idperfil = p.idperfil AND up.idusuario = $id_usuario ";
    ...
    function getperfiluser($id_usuario){
        ...
        $query_get ="SELECT idperfil FROM usuario_perfil  WHERE idusuario='".$id_usuario."' ";
        $result_user = $this->db->query($query_get);       
        return $result_user ->result_array();      
    }
    ...
    function recordusuarioperfilstandar($id_usuario){
        ...
        /*Verificamos que el perfil ya se encuentre registrado*/
            $query_get ="SELECT * FROM usuario_perfil WHERE idusuario='".$id_usuario."'  AND  idperfil = '1' ";
...
function getidempresabyidusuario($id_user){
  $query_get   ="SELECT idempresa FROM usuario WHERE idusuario = $id_user "; 
  $result = $this->db->query($query_get); 
  $idempresa = 0;
  foreach ($result ->result_array() as $row) {   
