                ...
                <div class="tab-pane active" role="tabpanel" id="plantillas_descripciones">                                                        
                    <section class="panel">
                        <header class="panel-heading blue-col-enid">
                            ...
                            <br>
                            <button   class='btn btn-default' data-toggle="modal" data-target="#modal-descripcion-eventos">
                        ...
                        <div class="col-md-12">
                            <section class="panel">
                                <header class="panel-heading blue-col-enid">
                                    ...
                                    Restricciones 
                                    <br>
                                    <button   class='btn btn-default' data-toggle="modal" data-target="#modal-restriccion-eventos">
                        ...
                        <div class="col-md-12">
                            <section class="panel">
                                <header class="panel-heading blue-col-enid">
                                    ...
                                    <br>                                        
                                    <button   class='btn btn-default' data-toggle="modal" data-target="#modal-articulo-eventos">
                    ...
                    <div class="form-group">                    
                        <section class="panel">
                            <header class="panel-heading blue-col-enid">
                                ...
                                Políticas
                                <br><button   class='btn btn-default' data-toggle="modal" data-target="#modal-politica-eventos">
