        ...
        <li id='panel-eventos' class='' >
          ...
          <div class="timeline-panel">
            <div class="timeline-heading">
                ...
                Con esta herramienta tu y los colaboradores de la organización 
          ...
          <div class="timeline-panel">
            <div class="timeline-heading">
                ...
                <a href="<?=base_url('index.php/recursocontroller/usuarios')?>">
                    <h4 class="timeline-title"><i class="fa fa-user"></i> Miembros de la cuenta</h4>
                </a>

              <p><small class="text-muted">
                Gestiona que personas pertenecen a la cuenta así como sus permisos y restricciones dentro de la misma.
              </small></p>
            </div>
            <div class="timeline-body">              
            </div>
        ...
        <li id='plantillas-section-panel'>
          ...
          <div class="timeline-panel">
            <div class="timeline-heading">
              ...
              <p>
                <small class="text-muted"> 
                    Las plantillas son textos ágiles que te permitirán escribir continuamente las politicas de los eventas, reglas,  restricciones y demás 
