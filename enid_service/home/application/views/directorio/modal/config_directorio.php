                    ...
                    <div class='col-lg-6 col-md-6 col-sm-6 col-sm-6 col-md-6 '>
                        <div class="form-group">            
                            <div class="input-group m-bot15">
                                ...
                                <input class="form-control" name="telefono"   placeholder="Teléfono" type="tel" required>
                            </div>
                        </div>
                    </div>     
                    <div class='col-lg-6 col-md-6 col-sm-6 col-md-6 col-sm-6 '>
                     <div class="form-group">            
                         <div class="input-group m-bot15">
                            ...
                            <input class="form-control" name="movil"   placeholder="Teléfono celular" type="tel">
                         </div>
                    ...
                    <div class='col-lg-6 col-md-6 col-sm-6'>
                     <div class="form-group">            
                         <div class="input-group m-bot15">
                            ...
                            <input class="form-control" name="pagina_fb"  type="text" placeholder='enidservice'>
                         </div>
                     </div>
                    </div>
                    <div class='col-lg-6 col-md-6 col-sm-6 '> 
                         <div class="form-group">            
                             <div class="input-group m-bot15">
                                ...
                                <input class="form-control" name="pagina_tw"  type="text" placeholder='enidservice'>
                             </div>
                        </div>
                     </div>
                </div> 
...
<form class='form-contactos-edit' id="form-contactos-edit" action="<?=base_url('index.php/api/contactos/contacto/format/json/')?>">    
        ...
        <div class='col-lg-6 col-md-6 col-sm-6 '>
         <div class="form-group">            
             <div class="input-group m-bot15">
                ...
                <input class="form-control" name="ntelefono"  id="ntelefono"   placeholder="Teléfono" type="tel" required>
             </div>
         </div>
         </div>
         <div class='col-lg-6 col-md-6 col-sm-6 '>
         <div class="form-group">            
             <div class="input-group m-bot15">
                ...
                <input class="form-control" name="nmovil" id="nmovil"   placeholder="Teléfono celular" type="tel">
             </div>
    ...
    <div class='col-lg-12 col-sm-12  col-md-12 '>
        ...
        <div class="form-group">            
             <div class="input-group m-bot15">
                ...
                <input class="form-control" name="npagina_web" id="npagina_web"   placeholder="www" type="url">
             </div>
         </div>
         </div>
    ...
    <div class='col-lg-12 col-sm-12 col-md-12 '>
        ...
        <div class='col-lg-4 col-md-4 col-sm-4'>
         <div class="form-group" >        
            <select class="form-control col-sm-12 col-lg-12 col-md-12" id="ntipo" name="ntipo">
