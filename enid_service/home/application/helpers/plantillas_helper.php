...
function politicas_contenido($data){
    $list = "<div class='scroll-vertical-enid' style='height:350px;'> <ul class='activity-list'>";  
    $flag =  1; 
    foreach ($data as $row) {
...
function display_contenido_templ($data_contenido, $del=0 , $check=0 , $identificador = 'identificador' ){
    ...
    $list_templa_contenido='<div class="panel"  style="overflow:scroll; height:500px;">
...
function list_objetos_permitidos_empresa( $arreglo ){ 
    ...
    $complete ="";
    $list ='<table id="obj-permitidos" class="table table-bordered" >        
