...
DELIMITER $$
USE `enidserv_eniddbbbb3`$$
create procedure insert_punto_venta_empresa_usuario(r_social  varchar(100) ,   estatus varchar(300) , empresa int , descripcion_punto text, id_user int )
begin 
INSERT INTO punto_venta(razon_social,  status , descripcion, idempresa ) VALUES ( r_social,  estatus  , descripcion_punto , empresa );
