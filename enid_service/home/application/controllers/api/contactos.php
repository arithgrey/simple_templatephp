...
class Contactos extends REST_Controller{
  ...
  function contacto_q_img_GET(){
      ...
      $q =  $this->get("q");
      $db_response = $this->contactmodel->get_contacto_filtro_q( $id_usuario , $q);        
      /**/             
      $this->response(filtro_enid_busqueda_contactos($db_response , "result-busqueda-contacto" , "idcontacto" ));
  ...
  function contacto_get(){
      ...
      $this->validate_user_sesssion();
      $id_usuario =  $this->sessionclass->getidusuario();      
      $response_db =  $this->contactmodel->get_contactos_user($id_usuario, $this->get() , 10);
      $this->response( table_contac($response_db , 10 ) );      
      $this->response($response_db);
  }
  /**/
  ...
  function contacto_put(){
      ...
      $response_db = $this->contactmodel->update( $nombre , $organizacion , $telefono, $movil          
                    , $correo , $direccion, $tipo , $id_usuario, $nota , $pagina_web , $id_contacto , $pagina_fb , $pagina_tw ,  $correo_alterno);      
