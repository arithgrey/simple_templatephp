...
class Emp  extends CI_Controller{
    ...
    /*
    Los eventos mas vistos
Si hoy es el evento mostrar 
Mostrar en que oferta estamos de los eventos
Si hay promo especial 
Si agregaron a alguien a la cuenta  
Si alguien cargo un evento 
Si se cargaron escenarios 
