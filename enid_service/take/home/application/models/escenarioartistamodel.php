...
/**/
function registraartistaescenario($idescenario , $nuevoartista , $idempresa, $id_evento ){
	...
	if ($registroartista[0] ==  true) {
		...
		return $this->nuevoescenarioartista($idescenario , $idartista , $id_evento , $nuevoartista );
...
function nuevoescenarioartista($idescenario , $idartista , $id_evento , $artista){
