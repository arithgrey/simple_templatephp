...
function insert( $nombre_acceso  , $precio , $inicio_acceso , $termino_acceso , $idevento , $idtipo_acceso, $descripcion=''){

	if ($precio< 1 ){		
		$precio = 1;		
	}	
	$query_insert ="INSERT INTO acceso( nombre  , precio , inicio_acceso ,  termino_acceso , idevento ,idtipo_acceso , descripcion  ) VALUES ( '$nombre_acceso' ,  $precio , '$inicio_acceso' , '$termino_acceso' , '$idevento' , '$idtipo_acceso'  , '$descripcion')";	
