...
class Tendencias extends CI_Controller {
    ...
    function index(){
        ...
        $id_empresa =  $this->sessionclass->getidempresa();          
        $data_global = $this->tendencias_model->global_eventos($id_empresa);
        $data["funel"] =  get_jfunnel($data_global);
        $this->dinamic_view_event('tendencias/eventos_principal', $data);                         
