...
class Escenario extends REST_Controller{      
    ...
    function escenario_evento_POST(){
        ...
        $this->response($this->escenariomodel->nuevo( validate_text($nombre)  , $id_evento ,  $id_empresa  )  );
    ...
    function escenario_artista_post(){
        ...
        $id_empresa =  $this->sessionclass->getidempresa();                                        
        $responsedb = $this->escenarioartistamodel->registraartistaescenario($id_escenario , validate_text($nuevoartista)  , $id_empresa , $id_evento );
        $this->response($responsedb);                 
