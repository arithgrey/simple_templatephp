...
class Directorio  extends CI_Controller {
	...
	function proveedoresadv(){
        ...
        $this->dinamic_view_event('directorio/proveedores_directorio_avanzado', $data);
	}
	...
	function contactos(){    		
        ...
        /**/          
        $response_db_contactos =  $this->contactmodel->get_contactos_user($id_usuario, $this->input->get());          
        $data["contactos_list"] =  table_contac($response_db_contactos);
        /**/
