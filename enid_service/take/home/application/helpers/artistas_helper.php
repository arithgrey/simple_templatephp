			...
			$horario = "por definir";
                ...
                $artistas_in_evento.='<div class="details">
                                        <div class="title" style="font-size:.9em !important;">
                                        	...
                                        	<a title="Define la participación del artista" href="" data-toggle="modal" data-target="#modal_tipo_artista"><i class="fa fa-bars tipo_artista" id="'.$id_artista.'"></i></a> 
                                            ...
                                            <div class="pull-right">
	                                            ...
	                                            data-target="#edit-nombre-artista"   title="artista"  >
	                                            	<h1 class="artistas-inputs" id="'. $id_artista .'"   >'. $nombre_artista .'</h1>
	                                            </a>
                                            <div>
