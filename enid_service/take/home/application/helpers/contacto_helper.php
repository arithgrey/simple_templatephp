...
if(!function_exists('invierte_date_time')){
	function table_contac($data){
		...
		foreach ($data as $row) {
			...
			<i id="'. $idcontacto.'" class="nota-c fa fa-list-alt" ></i></td>';						
			$contacto .='<td data-toggle="modal" data-target="#contact-modal-edit" ><i id="'. $idcontacto.'" class="editar-contacto fa fa-pencil-square-o" ></i></td>
			</tr>';			
			$b++;
		}
		...
		$contacto .="		
		</table><span class=''>Resultados encontrados:  ". ($b -1)."<span>
		";
		return $contacto;	
	}
