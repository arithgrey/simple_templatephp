...
<body class='content-enid'>
    ...
    <div class='contenedor-principal'>
        ...
        <a href="<?=base_url('index.php/startsession')?>" class='btn btn-default btn_save inicia'>            
            Iniciar sessión                    
        </a>
        ...
        <?=construye_header_modal('modal_usos_privacidad', "Condiciones de uso y privacidad Enid Service ");?>  
            <iframe src='<?=base_url("index.php/home/usos_privacidad_enid_service")?>' width='100%'  height="1000px">
            </iframe>      
