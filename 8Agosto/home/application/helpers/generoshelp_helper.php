...
if(!function_exists('invierte_date_time')){
    ...
    function get_tags_generos($arreglo_generos , $id_evento  , $in_session ){  
        $url =  base_url('index.php/eventos/nuevo/'.$id_evento.'/generosmusicales/#portlet_tab5');
        ...
        $tags_generos .= '
                            <li class="tags_generos" title="Género que escucharás en el evento">
                              <a class="tags_generos_a">'.
                                $row["nombre"].'
                              </a>
                            </li>';
        }
