                            ...
                            <div class="panel">
                                <div class="panel-body">
                                    <div class="profile-desk">                                      
                                        ...
                                        <?=create_dinamic_input("nombre_user" ,  "nombre_user form-control input-sm" ,  "nombre_user"  ,  "nombre_user_e hidden_enid" ,  $data_user["nombre"] ,  "placeholder='Tu nombre ' "  ,  "text");?>                                        
                                        ...
                                        <span class='place_apellido_paterno'>
                                          ...
                                          <?=create_dinamic_input("apellido_paterno" ,  "apellido_paterno form-control input-sm" ,  "apellido_paterno"  ,  "apellido_paterno_e hidden_enid" ,  $data_user["apellido_paterno"] ,"placeholder='Tu apellido paterno ' "  ,  "text" );?>                                                                                
                                        ...
                                        <span class='place_apellido_materno'>
                                          ...
                                          <?=create_dinamic_input("apellido_materno" ,  "apellido_materno form-control input-sm" ,  "apellido_materno"  ,  "apellido_materno_e hidden_enid" ,  $data_user["apellido_materno"] ,  "placeholder='Tu apellido materno ' "  ,  "text");?>                                                                                
                                    ...
                                    <ul class="p-info">
                                        ...
                                        <li>
                                            ...
                                            <div class='tel_e  hidden_enid'>
                                              <?=create_dinamic_input("tel_contacto" ,  "tel_contacto form-control input-sm" ,  "tel_contacto"  ,  "tel_contacto_e " ,  $data_user["tel_contacto"]  ,  "placeholder='Número telefónico' " ,  "number");?>                                                                                
                                            </div>
                                        </li>
                                        <li>
                                            ...
                                            <div class='tel_e2  hidden_enid'>
                                              <?=create_dinamic_input("tel_contacto2" ,  "tel_contacto2 form-control input-sm" ,  "tel_contacto2"  ,  "tel_contacto_e2" ,  $data_user["tel_contacto_alterno"] );?>                                                                                
                                            </div>
                                ...
                                <div class="panel-body p-states">
                                    <div class="summary pull-left">
                                          ...
                                          <div class='user_rfc_e hidden_enid' >
                                            <?=create_dinamic_input("rfc" ,  "rfc form-control input-sm" ,  "rfc"  ,  "rfc_input" ,  $data_user["rfc"] );?>                                                                                
                                          </div>
