...
function upload_data_youtube(){
	...
	evento = $("#evento").val();
	data_send =  $("#form-arista-social-sound").serialize() + "&"+ $.param({"social" : "youtube"  , "escenario" :  escenario , "url" :  url_youtube , "evento" : evento }); 
