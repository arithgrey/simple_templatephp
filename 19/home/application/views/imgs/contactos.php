<div class="modal-body">
    <!--<form action ='<?=base_url("application/controllers/api/imgs_controller.php")?>'  method="post" id="form_img_enid_contacto" enctype="multipart/form-data" id='formulario-principal-img' >-->
    <form accept-charset="utf-8" method="POST" id="form_img_enid_contacto"  class="form_img_enid_contacto" enctype="multipart/form-data" >      
		...
		<input class='dinamic_contacto' id='dinamic_contacto' name='dinamic_contacto' type='hidden'>
		<center>
			<br>	
