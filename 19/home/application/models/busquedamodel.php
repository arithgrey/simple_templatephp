...
function load_eventos_busqueda($param){
	...
	$this->cargamos_base_img_eventos();
	$query_get ="SELECT 
				e.idempresa, 
				emp.nombreempresa, 
				idevento ,
				...
				on e.idevento  =  ie.id_evento 
				left outer join  tmp_img i 
...
/**/
function cargamos_base_img_eventos(){
	$query_procedure ="CALL create_tmp_img(1);";
