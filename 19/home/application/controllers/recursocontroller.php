...
class Recursocontroller extends CI_Controller {
	...
	function usuarios($limit=10){
	    ...
	    $integrantes  = $this->cuentageneralmodel->getintegrantesinforme($id_user,  $id_empresa , $limit );								
		...
		$data["lista_perfiles"] = create_select($perfiles , "busqueda-perfil" , 'busqueda-perfil form-control input-sm' , 'busqueda-perfil' , 'nombreperfil' , 'idperfil');
