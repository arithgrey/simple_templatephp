...
class Accesos extends CI_Controller {
    ...
    function configuracionavanzada($id_acceso, $id_evento){
        ...
        $pv_resumen =  $this->puntoventamodel->get_resumen_accesos($id_evento); 
        $data["resumen_accesos"] = resumen_puntos_venta_f($pv_resumen );
        $puntos_asociados =  $this->puntoventamodel->get_puntos_venta_asociadas($id_evento); 
        $data["resumen_puntos_venta_asociados"] = get_resumen_puntos_venta_asociados($puntos_asociados );
