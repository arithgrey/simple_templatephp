...
class Escenario extends REST_Controller{      
    ...
    function resumenpublic_GET(){
        ...
        $escenarios_public = list_resum_escenarios($list_escenarios, $id_evento , 500 , "" ,  1);        
    ...
    function escenario_artista_get(){
        ...
        $response = list_artistas_escenario_tmp($db_response, 'Artistas que se presentarán en este escenario' , 1 , $id_escenario);
