function editrecursonow(e){
    ...
    showonehideone(inputdescription , "#"+this.id );
    ...
    $(inputdescription).blur(function(){        
        showonehideone( ".editar_recurso"  , ".inputdescription" );         
...
function eliminarecurosnow(e){
  ...
  $("#deleteconformbtn").click(function(){      
      ...
      $.post(url , {"idrecurso" : id_recurso }).done(function(data){
          if (data == true){
