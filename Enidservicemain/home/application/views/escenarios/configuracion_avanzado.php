        ...
        <div class="modal-content">
            ...
            <div class="modal-body">    		
                <form id="form-nueva-fecha">
                    ...
                    <button class='btn btn-primary' id='btn-guardar-fecha'>
                        Guardar
                    </button>
    ...
    <div class="modal-dialog">
        <div class="modal-content">        
            ...
            <div class="modal-body">    
                ...
                <div class='col-lg-12'>
                    <button type="button" class="pull-left guardar_horario btn btn-default" data-dismiss="modal">
                                            Guardar
                    </button>
                </div>
            </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
           ...
           <div class="modal-body">                        
                   ...
                   <form'<?=base_url("application/controllers/api/imgs_controller.php")?>'  method="post" id="form_imgs_escenario" enctype="multipart/form-data" id='formulario-principal-img' >                    
