...
class Templ extends REST_Controller{
    ...
    function templates_contenido_post(){
        ...
        $db_response = $this->templmodel->record_template_contenido($iduser , $tipo_templ, $titulo_contenido_tmpl , $contenido_descripcion );
    ...
    function plantillaarticulos_post(){
        $this->validate_user_sesssion();       
    ...
    /*get articulos */
    function plantillaarticulos_get(){
    ...
    function templates_contenido_evento_post(){
            
        $id_contenido = $this->post("contenido");
        $id_evento = $this->post("evento");        
