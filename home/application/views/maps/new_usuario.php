...
<html>
  <head>
    ...
    <script type="text/javascript" src="<?=base_url('application/js/maps/usuario.js')?>">
    </script>
  ...
  <body>    
    ...
    <br>   
    <form class='form-registro-direccion' id='form-registro-direccion' action="<?=base_url('index.php/api/user/locacion/format/json/')?>">
      <input type='hidden' class='id_usuario' id='id_usuario' name='id_usuario' value="<?=$id_usuario?>"> 
