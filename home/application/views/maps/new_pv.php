...
<html>
  <head>
    ...
    <script type="text/javascript" src="<?=base_url('application/js/maps/puntos_venta.js')?>">
    </script>
  ...
  <body>    
    ...
    <div class='row'>  
      <div>                
          <input id="origin-input" value="<?=$info_locacion['formatted_address']?>" class="form-control input-sm input-nuevo " type="text" placeholder="La dirección del punto de venta">             
    ...
    <br>   
    <form class='form-registro-direccion' id='form-registro-direccion' action="<?=base_url('index.php/api/puntosventa/locacion/format/json/')?>">
      <input type='hiden' class='punto_venta' id='punto_venta' name='punto_venta' value="<?=$punto_venta?>"> 
      <input type='hidden' class='new_place_id' name='place_id' value="<?=$info_locacion['place_id']?>">
      <input type='hidden' class='new_formatted_address' id='new_formatted_address' name='formatted_address' 
