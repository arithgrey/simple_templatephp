...
<html>
  <head>
    ...
    <script type="text/javascript" src="<?=base_url('application/js/maps/evento.js')?>">
    </script>
  ...
  <body>    
    ...
    <br>   
    <form class='form-registro-direccion' id='form-registro-direccion' action="<?=base_url('index.php/api/event/locacion/format/json/')?>">
      <input type='hidden' class='id_evento' id='id_evento' name='id_evento' value="<?=$id_evento?>"> 
