...
<html>
  <head>
    ...
    <script type="text/javascript" src="<?=base_url('application/js/maps/contacto.js')?>">
    </script>
  ...
  <body>    
    ...
    <br>   
    <form class='form-registro-direccion' id='form-registro-direccion' action="<?=base_url('index.php/api/contactos/locacion/format/json/')?>">
      <input type='hidden' class='id_contacto' id='id_contacto' name='id_contacto' value="<?=$id_contacto?>"> 
