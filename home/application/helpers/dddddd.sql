...
START TRANSACTION;
USE `enidserv_eniddbbbb3`;
INSERT INTO `enidserv_eniddbbbb3`.`usuario` (`idusuario`, `nombre`, `email`, `password`, `fecha_registro`, `idempresa`, `descripcion`, `puesto`, `status`, `apellido_paterno`, `apellido_materno`, `email_alterno`, `tel_contacto`, `tel_contacto_alterno`, `edad`, `numero_empleado`, `inicio_labor`, `fin_labor`, `grupo`, `cargo`, `rfc`, `turno`, `ultima_modificacion`, `descripcion_usuario`, `url_fb`, `url_tw`, `url_www`, `sexo`) VALUES (1, 'arithgrey', 'arithgrey@gmail.com', '870058cbcebe244bce513be539acd6905bca8d99', NULL, 1, NULL, 'Presidente ejecutivo', 'Usuario Activo', 'Medrano', 'Salazar', 'enidservice@gmail.com', 5573355891, 5545444823, 25, NULL, '09:00 AM', '18:00 PM', 'Desarrollo', 'Presidente Ejecutivo', NULL, 'Matutino', NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `enidserv_eniddbbbb3`.`usuario` (`idusuario`, `nombre`, `email`, `password`, `fecha_registro`, `idempresa`, `descripcion`, `puesto`, `status`, `apellido_paterno`, `apellido_materno`, `email_alterno`, `tel_contacto`, `tel_contacto_alterno`, `edad`, `numero_empleado`, `inicio_labor`, `fin_labor`, `grupo`, `cargo`, `rfc`, `turno`, `ultima_modificacion`, `descripcion_usuario`, `url_fb`, `url_tw`, `url_www`, `sexo`) VALUES (2, 'estratega test', 'estrategatest@gmail.com', '870058cbcebe244bce513be539acd6905bca8d99', NULL, 1, NULL, 'Presidente ejecutivo', 'Usuario Activo', NULL, NULL, NULL, NULL, NULL, 25, NULL, '09:00 AM', '18:00 PM', 'Desarrollo', 'Presidente Ejecutivo', NULL, 'Matutino', NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `enidserv_eniddbbbb3`.`usuario` (`idusuario`, `nombre`, `email`, `password`, `fecha_registro`, `idempresa`, `descripcion`, `puesto`, `status`, `apellido_paterno`, `apellido_materno`, `email_alterno`, `tel_contacto`, `tel_contacto_alterno`, `edad`, `numero_empleado`, `inicio_labor`, `fin_labor`, `grupo`, `cargo`, `rfc`, `turno`, `ultima_modificacion`, `descripcion_usuario`, `url_fb`, `url_tw`, `url_www`, `sexo`) VALUES (3, 'administradortest', 'administradortest@gmail.com', '870058cbcebe244bce513be539acd6905bca8d99', NULL, 1, NULL, 'Administrador', 'Usuario Activo', NULL, NULL, NULL, NULL, NULL, 18, NULL, '09:00 AM', '18:00 PM', NULL, NULL, NULL, 'Matutino', NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `enidserv_eniddbbbb3`.`usuario` (`idusuario`, `nombre`, `email`, `password`, `fecha_registro`, `idempresa`, `descripcion`, `puesto`, `status`, `apellido_paterno`, `apellido_materno`, `email_alterno`, `tel_contacto`, `tel_contacto_alterno`, `edad`, `numero_empleado`, `inicio_labor`, `fin_labor`, `grupo`, `cargo`, `rfc`, `turno`, `ultima_modificacion`, `descripcion_usuario`, `url_fb`, `url_tw`, `url_www`, `sexo`) VALUES (4, 'tester', 'tester@gmail.com', 'f7c3bc1d808e04732adf679965ccc34ca7ae3441', NULL, 2, NULL, NULL, 'Usuario Activo', NULL, NULL, NULL, NULL, NULL, NULL, NULL, '09:00 AM', '18:00 PM', NULL, NULL, NULL, 'Matutino', NULL, NULL, NULL, NULL, NULL, NULL);
...
START TRANSACTION;
USE `enidserv_eniddbbbb3`;
INSERT INTO `enidserv_eniddbbbb3`.`punto_venta` (`idpunto_venta`, `razon_social`, `status`, `fecha_registro`, `idempresa`, `descripcion`, `zona`, `hora_inicio`, `hora_fin`, `L`, `M`, `MM`, `J`, `V`, `S`, `D`, `horario_atencion`, `sitio_web`) VALUES (1, 'Taquillas del evento', 'Disponible para todos los colaboradores de la empresa', NULL, 1, NULL, NULL, NULL, NULL, 0, 0, 0, 0, 0, 0, 0, NULL, NULL);
INSERT INTO `enidserv_eniddbbbb3`.`punto_venta` (`idpunto_venta`, `razon_social`, `status`, `fecha_registro`, `idempresa`, `descripcion`, `zona`, `hora_inicio`, `hora_fin`, `L`, `M`, `MM`, `J`, `V`, `S`, `D`, `horario_atencion`, `sitio_web`) VALUES (2, 'Patrocinadores del evento', 'Disponible para todos los colaboradores de la empresa', NULL, 1, NULL, NULL, NULL, NULL, 1, 1, 1, 1, 0, 0, 0, NULL, NULL);
