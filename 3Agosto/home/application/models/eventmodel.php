...
function get_img_evento($id_evento){
	...
	$query_get ="select 
				...
				where ie.id_evento = '". $id_evento."' LIMIT 10";
...
function create( $nombre , $edicion , $inicio , $termino , $id_usuario , $idempresa){
	...
	$query_insert ="INSERT INTO evento(
		...
		if ($dbresponse) {		
			...
			$db_response =  $this->insert_log(1 , "Registró el evento" , $id_evento ,  $id_usuario );
